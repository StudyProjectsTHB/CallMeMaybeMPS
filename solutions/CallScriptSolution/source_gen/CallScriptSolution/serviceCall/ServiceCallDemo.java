...
public class ServiceCallDemo extends ChatBot {
  ...
  public ServiceCallDemo() {
    this.setStartChatNode(new ContinuingChatNode("Start", "Herzlich willkommen, wie kann ich Ihnen helfen?", "", ListSequence.fromListAndArray(new ArrayList<Connection>(), new Connection(new OrKeyExpression(new SimpleKeyExpression("Kündigen"), new SimpleKeyExpression("wechseln")), "Change contract"), new Connection(new AndKeyExpression(new SimpleKeyExpression("bestellen"), new SimpleKeyExpression("Vertrag")), "New contract"), new Connection(new ActionKey("1"), "Change contract"), new Connection(new SimpleKeyExpression(""), "Start"))));
    ListSequence.fromList(this.middleChatNodes).addSequence(LinkedListSequence.fromLinkedListNew(LinkedListSequence.fromListAndArray(new LinkedList<ContinuingChatNode>(), new ContinuingChatNode("New contract", "Sie wollen also einen Vertrag abschließen?", "", ListSequence.fromListAndArray(new ArrayList<Connection>(), new Connection(new OrKeyExpression(new SimpleKeyExpression("Ja"), new OrKeyExpression(new SimpleKeyExpression("Stimmt"), new SimpleKeyExpression("Genau"))), "New contract yes"), new Connection(new OrKeyExpression(new SimpleKeyExpression("Nein"), new OrKeyExpression(new SimpleKeyExpression("Ne"), new SimpleKeyExpression("Auf keinen Fall"))), "Start"))), new ContinuingChatNode("Change contract", "Sie wollen also Ihren Vertrag kündigen ist das richtig?", "", ListSequence.fromListAndArray(new ArrayList<Connection>(), new Connection(new OrKeyExpression(new SimpleKeyExpression("Ja"), new OrKeyExpression(new SimpleKeyExpression("Stimmt"), new SimpleKeyExpression("Genau"))), "Get contract number"), new Connection(new OrKeyExpression(new SimpleKeyExpression("Nein"), new OrKeyExpression(new SimpleKeyExpression("Ne"), new SimpleKeyExpression("Auf keinen Fall"))), "Start"), new Connection(new SimpleKeyExpression(""), "Change contract"))), new ContinuingChatNode("Is contract number", "Ist das Ihre Vertragsnummer:", "Get contract number", ListSequence.fromListAndArray(new ArrayList<Connection>(), new Connection(new OrKeyExpression(new SimpleKeyExpression("Ja"), new OrKeyExpression(new SimpleKeyExpression("Genau"), new SimpleKeyExpression("Stimmt"))), "Change contract number"), new Connection(new OrKeyExpression(new SimpleKeyExpression("Nein"), new OrKeyExpression(new SimpleKeyExpression("Ne"), new SimpleKeyExpression("Auf keinen Fall"))), "Get contract number"), new Connection(new SimpleKeyExpression(""), "Is contract number"))))));
